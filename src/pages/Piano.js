...
const Piano = () => {
  ...
  return (
    <div className="piano_main_wrapper">
      ...
      <div className="piano">
        <div data-key={83} id="83" className="piano_key white" onClick={handleClick}>
          S
        </div>
        <div data-key={69} id="69" className="piano_key black" onClick={handleClick}>
          E
        </div>
        <div data-key={68} id="68" className="piano_key white" onClick={handleClick}>
          D
        </div>
        <div data-key={82} id="82" className="piano_key black" onClick={handleClick}>
          R
        </div>
        <div data-key={70} id="70" className="piano_key white" onClick={handleClick}>
          F
        </div>
        <div data-key={71} id="71" className="piano_key white" onClick={handleClick}>
          G
        </div>
        <div data-key={89} id="89" className="piano_key black" onClick={handleClick}>
          Y
        </div>
        <div data-key={72} id="72" className="piano_key white" onClick={handleClick}>
          H
        </div>
        <div data-key={85} id="85" className="piano_key black" onClick={handleClick}>
          U
        </div>
        <div data-key={74} id="74" className="piano_key white" onClick={handleClick}>
          J
        </div>
        <div data-key={73} id="73" className="piano_key black" onClick={handleClick}>
          I
        </div>
        <div data-key={75} id="75" className="piano_key white" onClick={handleClick}>
          K
        </div>
      </div>
